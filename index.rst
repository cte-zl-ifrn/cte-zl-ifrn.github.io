.. CTE/ZL/IFRN documentation master file, created by
   sphinx-quickstart on Wed Nov 17 12:55:17 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Bem vindo à documentação pública do ecossistema da CTE/ZL/IFRN!
=======================================
